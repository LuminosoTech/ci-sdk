...
client.get(
  ...
  (res) => {
    ...
    res.on("end", () => {
      ...
      const buffer = fs.readFileSync("./node_modules/@luminoso/ci-sdk/i18n/i18n-templates/index-template.txt");
  ...
  (res) => {
    ...
    res.on("end", () => {
      ...
      for (const language of parsedData.languages) {
        ...
        // eslint-disable-next-line no-loop-func
        const buffer = fs.readFileSync("./node_modules/@luminoso/ci-sdk/i18n/i18n-templates/language-template.txt");
